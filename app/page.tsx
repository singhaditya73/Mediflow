...
import { ArrowRight, Database, FileText, Lock, Shield, Upload, Zap } from "lucide-react"
      ...
      <div className="container px-4 py-6 mx-auto relative z-10">
        <header className="flex items-center justify-between py-4">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <Link href="/results" className="text-sm font-medium text-muted-foreground hover:text-foreground">
              Results
            </Link>
            <Link href="/access-control" className="text-sm font-medium text-muted-foreground hover:text-foreground">
              Access Control
            </Link>
          </nav>
        ...
        <main className="py-12">
          <section className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Transform unstructured clinical data into standardized FHIR format with Web3 technology for enhanced
              security and patient control.
            </p>
          ...
          <section className="grid md:grid-cols-3 gap-8 mt-24">
            <Card className="bg-card/50 backdrop-blur-sm border border-border shadow-lg hover:shadow-xl transition-shadow rounded-xl overflow-hidden group">
              ...
              <CardHeader className="pb-2">
                ...
                <CardTitle className="text-xl text-foreground">Easy Data Upload</CardTitle>
                <CardDescription className="text-muted-foreground">
                  Drag & drop your files or paste your data directly into the converter.
                </CardDescription>
              </CardHeader>
            ...
            <Card className="bg-card/50 backdrop-blur-sm border border-border shadow-lg hover:shadow-xl transition-shadow rounded-xl overflow-hidden group">
              ...
              <CardHeader className="pb-2">
                ...
                <CardTitle className="text-xl text-foreground">FHIR Conversion</CardTitle>
                <CardDescription className="text-muted-foreground">
                  Instantly convert your clinical data to standardized FHIR JSON format.
                </CardDescription>
              </CardHeader>
              <CardFooter className="pt-2">
                <Link
            ...
            <Card className="bg-card/50 backdrop-blur-sm border border-border shadow-lg hover:shadow-xl transition-shadow rounded-xl overflow-hidden group">
              ...
              <CardHeader className="pb-2">
                ...
                <CardTitle className="text-xl text-foreground">Secure Access Control</CardTitle>
                <CardDescription className="text-muted-foreground">
                  Manage who can access your converted healthcare data with ease.
                </CardDescription>
              </CardHeader>
              <CardFooter className="pt-2">
                <Link
          ...
          <section className="mt-24 max-w-5xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-foreground mb-4">About MediFlow</h2>
              <div className="w-24 h-1 bg-gradient-to-r from-teal-500 to-blue-500 mx-auto mb-6"></div>
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                MediFlow is transforming healthcare data management by standardizing unstructured clinical data into
                FHIR format. By integrating Web3 technologies, we offer decentralized identity management, enhanced data
                privacy, and immutable audit trails.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="bg-card/50 backdrop-blur-sm border border-border rounded-2xl shadow-lg overflow-hidden">
                <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-teal-500 to-blue-500"></div>
                <Image src="/placeholder.svg" alt="MediFlow Platform"  width={700} 
            height={350} className="w-full h-auto" />
              </div>
              <div className="space-y-6">
                <p className="text-muted-foreground">
                  Our platform empowers patients to control their health data while ensuring secure, interoperable data
                  exchange among healthcare providers. Trust, transparency, and security are at the core of MediFlow,
                  enabling a seamless healthcare experience for all.
                </p>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-foreground mb-1">Decentralized Identity</h3>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-foreground mb-1">Immutable Audit Trails</h3>
                      <p className="text-muted-foreground text-sm">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-foreground mb-1">Enhanced Data Privacy</h3>
                      <p className="text-muted-foreground text-sm">
          ...
          <section className="mt-24 max-w-5xl mx-auto bg-gradient-to-r from-teal-50/50 to-blue-50/50 dark:from-teal-900/20 dark:to-blue-900/20 rounded-2xl p-8 border border-border shadow-lg">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <h2 className="text-3xl font-bold text-foreground mb-4">Why Choose MediFlow?</h2>
                <p className="text-muted-foreground">
                  Our platform combines the latest in FHIR standards with cutting-edge Web3 technology to create a
                  secure, patient-centric healthcare data ecosystem.
                </p>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-foreground">FHIR R4 Compliance</h3>
                      <p className="text-sm text-muted-foreground">
                        Fully compliant with the latest FHIR R4 standards for maximum interoperability.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Secure, HIPAA-compliant processing with end-to-end encryption.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-foreground">Web3 Integration</h3>
                      <p className="text-sm text-muted-foreground">
                        Blockchain technology ensures data integrity and transparent access logs.
                      </p>
                    </div>
                  </li>
                </ul>
          ...
          <section className="mt-24 text-center">
            <h2 className="text-3xl font-bold text-foreground mb-4">Ready to Transform Your Healthcare Data?</h2>
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Join healthcare organizations worldwide who trust MediFlow for secure, standardized clinical data
              management.
            </p>
            <Button
              asChild
        ...
        <footer className="mt-24 py-8 border-t border-border">
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground">
                Transforming healthcare data management with Web3 technology and FHIR standardization.
              </p>
          ...
          <div className="mt-12 pt-8 border-t border-border text-center">
            <p className="text-sm text-muted-foreground">© 2025 MediFlow. All rights reserved.</p>
          </div>
        </footer>
      </div>
    </div>
