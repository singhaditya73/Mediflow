...
import { ArrowLeft, Github, Loader2, Mail, Zap } from "lucide-react"
          ...
          <Card className="bg-card/50 backdrop-blur-sm border border-border shadow-lg rounded-xl overflow-hidden">
            <CardHeader className="space-y-1">
              ...
              <CardDescription className="text-center">
                Sign up to access MediFlow&apos;s healthcare data standardization platform
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <Button
                  variant="outline"
                  className="w-full bg-card/50 hover:bg-card flex items-center justify-center gap-2"
                >
                  <svg
